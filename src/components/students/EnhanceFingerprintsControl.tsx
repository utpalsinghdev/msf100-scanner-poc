...
export default function EnhanceFingerprintsControl({ onEnhance, disabled }: Props) {
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button variant="secondary" disabled={disabled || running} className="gap-2">
          ...
          {running ? 'Enhancing…' : 'Enhance fingerprints'}
        </Button>
      </PopoverTrigger>
      <PopoverContent align="end" className="w-80">
        <div className="space-y-4">
          <div>
            <h4 className="font-semibold text-slate-900">Enhance fingerprints</h4>
